...
<?= $this->tag->form(['messages/search', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?= $this->tag->textArea(['message', 'cols' => '30', 'rows' => '4', 'class' => 'form-control', 'id' => 'fieldMessage']) ?>
    </div>
</div>
