...
abstract class AbstractAdapter implements AdapterInterface
{
    ...
    protected function post($url, $params, $parse = true)
    {
        ...
        SupportClass::writeMessageInLogFile("Запрос POST к соц. сети: ".$url);
    ...
    protected function get($url, $params, $parse = true)
    {
        ...
        SupportClass::writeMessageInLogFile("Запрос GET к соц. сети: ".$url . '?' . urldecode(http_build_query($params)));
        ...
        SupportClass::writeMessageInLogFile("Результат запроса: ".$result);
